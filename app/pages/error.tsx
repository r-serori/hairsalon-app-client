  ...
  const getMessage = () => {
    switch (Number(code)) {
      ...
      case 403:
        dispatch(
          changeMessage(
            "アクセス権限がありません。ユーザー登録画面へ移動し、ユーザー登録してください。"
          )
        );
        return "アクセス権限がありません。アクセス権限がありません。ユーザー登録画面へ移動し、ユーザー登録してください。";
      case 404:
        dispatch(changeMessage("お探しのページが見つかりません。"));
      ...
      case 500:
        dispatch(
          changeMessage(
            "サーバーエラーが発生しました。しばらくしてからもう一度お試しください。復旧しない場合は、管理者にお問い合わせください。"
          )
        );
      ...
      case 503:
        dispatch(
          changeMessage(
            "サービスが一時的に利用できません。しばらくしてからもう一度お試しください。復旧しない場合は、管理者にお問い合わせください。"
          )
        );
